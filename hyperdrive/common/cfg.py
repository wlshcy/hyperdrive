...
class ConfigParser(BaseParser):
    """The configuration parse object. All configurations will be collected
       in a dictionary called `_opts`. Currently only configurations those
    ...
    def __init__(self):
        ...
        """This dictionary contains all the configuration"""
        self._opts = {}
